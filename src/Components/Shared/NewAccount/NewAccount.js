                ...
                <div className="container d-flex justify-content-center align-items-center">
                    <div className=" border border-dark rounded p-5">
                        <form className='NewAccount-form' onSubmit={EmailAndPasswordSignUp} >
                            ...
                            < input className='input' id="email" name="email" placeholder="Email" onBlur={getEmail}  required />
                            < input className='input' type='password' name="password"placeholder="Passowrd" onBlur={getPassword} required />
                            <input className='submit-button' type="submit" value="Sign Up" />
                            <p className='text-center text-dark mt-2'><small>Already have an account?  <Link to='/login' className='create-acc-link disabled'>Login</Link></small></p>
                        </form>
                        ...
                        <div className="d-flex justify-content-center">
                            <div>
                                <div className="d-flex justify-content-center">
                                    <button onClick={handleGoogleSignIn} className="btn NewAccount-with-google my-2"><FontAwesomeIcon icon={faGoogle} className='me-3' />Continue with google</button>
                                </div>
