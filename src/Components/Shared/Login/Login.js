            ...
            <main className='d-flex justify-content-center align-items-center bg-90'>
                <div className="container d-flex justify-content-center align-items-center">
                    <div className=" border border-dark rounded p-5">
                        <form className='login-form' onSubmit={HandleEmailAndPasswordSignIn}>
                            <h4 className="login-title">Login</h4>
                            < input className='input' name="email" placeholder="Email" onBlur={getEmail} required />
                            < input className='input' type='password' name="password"placeholder="Passowrd" onBlur={getPassword} required />
                            <input className='submit-button' type="submit" value="Login"  />
                            <p className='text-center text-dark mt-2'><small>Don't have an account?  <Link to='/new' className='create-acc-link disabled'>Create a new one</Link></small></p>
